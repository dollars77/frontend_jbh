    ...
    <div className="min-h-screen bg-gray-50 p-2">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex gap-1">
          ...
          <div className="w-20 sm:w-24 md:w-52 flex-shrink-0">
            <div className="bg-white rounded-md shadow-sm border border-gray-200 sticky top-2">
                  ...
                  >
                    <div className="mb-1 md:mb-2">
                      <div className="w-7 h-7 lg:w-10 lg:h-10 flex items-center justify-center">
                        <Image width={512} height={512} alt={category.namecategory} src={index===0?category.iconcategory:URL_HOST+category.iconcategory} />
                      </div>
                    </div>
              ...
              <div className="p-2 lg:p-6 border-b border-gray-200">
                <div className="flex items-center gap-3">
                  <p className="text-xs lg:text-base text-center font-semibold text-gray-900">
                    (Full Wordpress Landing Page) รับออกแบบเว็บไซต์ Wordpress (Unlimited ฟรี!!) ซึ่งท่านจะได้รับธีมตามที่โชว์ทั้งหมดทุกส่วนและท่านสามารถจัดการ รูปภาพ,ข้อความ,พื้นหลังได้ทั้งหมดด้วย Widgets และ Elementor
                  </p>
                </div>
              </div>
              ...
              <div className=" p-2 lg:p-6 max-h-screen overflow-y-scroll">
                {activeCategory?.websites.length>0 ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500">No websites available for this category</p>
                  </div>
                )}
              </div>
            </div>
